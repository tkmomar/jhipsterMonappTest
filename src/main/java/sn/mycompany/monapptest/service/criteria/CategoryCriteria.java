...
/**
 * Criteria class for the {@link sn.mycompany.monapptest.domain.Category} entity. This class is used
 * in {@link sn.mycompany.monapptest.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, postId, distinct);
    }
