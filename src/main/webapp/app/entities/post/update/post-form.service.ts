 ...
 */
type FormValueOf<T extends IPost | NewPost> = Omit<T, 'dateCreation'> & {
...
type PostFormDefaults = Pick<NewPost, 'id' | 'dateCreation'>;
...
type PostFormGroupContent = {
  ...
  dateCreation: FormControl<PostFormRawValue['dateCreation']>;
...
export class PostFormService {
  createPostFormGroup(post: PostFormGroupInput = { id: null }): PostFormGroup {
    ...
    return new FormGroup<PostFormGroupContent>({
      ...
      dateCreation: new FormControl(postRawValue.dateCreation),
  ...
  private convertPostRawValueToPost(rawPost: PostFormRawValue | NewPostFormRawValue): IPost | NewPost {
    return {
      ...rawPost,
      dateCreation: dayjs(rawPost.dateCreation, DATE_TIME_FORMAT),
    };
  }
  ...
  private convertPostToPostRawValue(
    ...
    return {
      ...post,
      dateCreation: post.dateCreation ? post.dateCreation.format(DATE_TIME_FORMAT) : undefined,
    };
  }
}
